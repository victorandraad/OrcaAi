<x-app-layout>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('formulas.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('name') border-red-500 @enderror" type="text" name="name" id="name" required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex flex-col">
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="formula" id="formula" readonly>
    ...
    <script>
        function addToFormula(value) {
           ...
           //Validão para evitar [material_id] seguido de número ou ponto decimal
